...
public class FigureAdapter extends RecyclerView.Adapter<FigureAdapter.FigureViewHolder> {
    ...
    public FigureAdapter(Context context, List<Figure> figures, OnFigureClickListener listener) {
    ...
    public FigureViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_historical_figure, parent, false);
    ...
    static class FigureViewHolder extends RecyclerView.ViewHolder {
        ...
        FigureViewHolder(@NonNull View itemView) {
            super(itemView);
            figureImage = itemView.findViewById(R.id.figurePic);
